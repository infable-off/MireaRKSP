                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink href={route('dashboard')} active={route().current('dashboard')}>
                                    <span>Online-Cinema-Rtu</span>
                                </NavLink>
                                {/*<Link to="dashboard" style={{textDecoration: "none"}}><span>Online-Cinema-Rtu</span></Link>*/}
                                {/*<NavLink href={route('/movies/popular')}>*/}
                                {/*    <span>Popular</span>*/}
                                {/*</NavLink>*/}
                                ...
                                {/*<NavLink to="/" style={{textDecoration: "none"}}><span>Online-Cinema-Rtu</span></NavLink>*/}
